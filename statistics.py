...
class Statistics:
    ...
    def plot_stats(self):
        Plot([i / conf.SIM_LAST for i in self.daily_arr.values()], title="Arrivals by hour").plot_by_hour()
        ...
        MultiPlot(y, xvalues=range(conf.SIM_LAST), title="Consumption", ylabel="Energy [Wh]").plot(["Tot", "Grid", "SPV"])
        ...
        MultiPlot(y, xvalues=range(conf.SIM_LAST), title="Costs", ylabel="Euro").plot(["Tot", "Net", "Saving"])
